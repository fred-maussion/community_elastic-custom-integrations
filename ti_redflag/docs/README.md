...
| event.provider | Which of the integration's two fetch mechanisms produced this document -- `full_fetch` (periodic reconciliation of the complete feed) or `daily_diff` (the vendor's daily diff feed). | keyword |
